...
export async function configureTwilioNumber(phoneNumber, options = {}) {
  try {
    ...
    const voiceUrl = options.voiceUrl || 
      `${process.env.API_BASE_URL || 'https://smarttext-webhook-kyle-davis-projects-30fc1531.vercel.app'}/api/twilio/voice`;
    const statusCallback = options.statusCallback || 
      `${process.env.API_BASE_URL || 'https://smarttext-webhook-kyle-davis-projects-30fc1531.vercel.app'}/api/missed-call`;
