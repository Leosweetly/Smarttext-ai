...
/**
 * Direct test script for the online ordering URL detection in /api/new-message
 * 
 ...
 * 
 * Usage: node scripts/test-online-ordering-direct.js
 */
...
console.log(chalk.bold.green('  ONLINE ORDERING URL DETECTION TEST'));
console.log(chalk.bold.green('================================================='));
