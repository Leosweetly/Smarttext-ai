...
/**
 * End-to-End Test Script for SmartText API Endpoints (Debug Version)
 * 
...
async function runTests() {
  ...
  console.log(chalk.yellow('DEBUG MODE: Additional logging enabled'));
  ...
  if (missedCallResult) {
    ...
    if (missedCallResult && newMessageResult) {
