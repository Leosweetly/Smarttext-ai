/**
 * Test script for the update-business-info-v2 API endpoint
 * 
...
const endpoints = [
  ...
  },
  {
    ...
    url: process.env.NEXT_PUBLIC_API_BASE_URL + '/api/update-business-info-v2',
    enabled: true
  }
];
...
// Test data
const testData = {
  name: 'Test Business V2 ' + new Date().toISOString().slice(0, 16).replace('T', ' '),
...
async function runTests() {
  console.log(chalk.blue('🧪 Testing update-business-info-v2 API endpoints...'));
